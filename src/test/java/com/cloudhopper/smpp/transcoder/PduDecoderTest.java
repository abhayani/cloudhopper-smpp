...
public class PduDecoderTest {
	private static final Logger logger = LoggerFactory
			.getLogger(PduDecoderTest.class);
	...
	public void decodeLessThan16Bytes() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("0000001000000015000000000a342e");
	...
	public void decodeUnsupportedRequestCommandId() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("0000001000000110000000000a342ee7");
		...
		// an unsupported command id is recoverable and all the bytes should
		// have been read
	...
	public void decodeUnsupportedResponseCommandId() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("0000001080000110000000000a342ee7");
	...
	public void decodeSignedIntLength() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("F000001100000110000000000a342ee7");
		try {
			EnquireLink pdu0 = (EnquireLink) transcoder.decode(buffer);
			Assert.fail();
	...
	public void decodeMaxSequenceNumber() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("0000001000000015000000007fffffff");

		EnquireLink pdu0 = (EnquireLink) transcoder.decode(buffer);

		Assert.assertEquals(16, pdu0.getCommandLength());
		Assert.assertEquals(SmppConstants.CMD_ID_ENQUIRE_LINK,
				pdu0.getCommandId());
		Assert.assertEquals(0, pdu0.getCommandStatus());
	...
	public void decodeTooBigSequenceNumber() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("00000010000000150000000080000000");

		try {
			EnquireLink pdu0 = (EnquireLink) transcoder.decode(buffer);
			// this should work now that we support 32 bits for a sequence
			// number
		} catch (UnrecoverablePduException e) {
			Assert.fail();
		}

		// despite having too large a sequence number, all the bytes should have
		// been read
		Assert.assertEquals(0, buffer.readableBytes());
	}
	...
	public void decodeZeroSequenceNumber() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("00000010000000150000000000000000");
	...
	public void decodeSequenceNumberOfOne() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("00000010000000150000000000000001");
		EnquireLink pdu0 = (EnquireLink) transcoder.decode(buffer);
	...
	public void decodeEnquireLink() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("0000001000000015000000000a342ee7");
	...
	public void decodeEnquireLinkResp() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("0000001080000015000000000a342eed");

		EnquireLinkResp pdu0 = (EnquireLinkResp) transcoder.decode(buffer);

		Assert.assertEquals(16, pdu0.getCommandLength());
		Assert.assertEquals(SmppConstants.CMD_ID_ENQUIRE_LINK_RESP,
				pdu0.getCommandId());
		Assert.assertEquals(0, pdu0.getCommandStatus());
	...
	@Test
	public void decodeTwoEnquireLinkRespButWithReadRequiredInBetween()
			throws Exception {
		...
		ChannelBuffer buffer1 = ChannelBuffers.wrappedBuffer(buffer, buffer0); // merge
																				// both
																				// buffers...
		buffer = buffer1;
	...
	public void decodeSubmitSmResp() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("0000001c80000004000000000a342ee1393432353834333135393400");
	...
	public void decodeSubmitSmRespWithNoMessageId() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("0000001080000004000000000a342ee1");
	...
	public void decodeSubmitSmRespWithEmptyMessageId() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("0000001180000004000000000a342ee100");
	...
	public void decodeSubmitSmRespWithNoNullByteForMessageId() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("0000001180000004000000000a342ee139");
		...
		Assert.assertEquals(17, pdu0.getCommandLength());
		Assert.assertEquals(SmppConstants.CMD_ID_SUBMIT_SM_RESP,
				pdu0.getCommandId());
		Assert.assertEquals(0, pdu0.getCommandStatus());
		Assert.assertEquals(171192033, pdu0.getSequenceNumber());
		Assert.assertEquals(true, pdu0.isResponse());
	...
	public void decodeDeliverSmResp() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("0000001c800000050000000000116ac7393432353834333135393400");

		DeliverSmResp pdu0 = (DeliverSmResp) transcoder.decode(buffer);

		Assert.assertEquals(28, pdu0.getCommandLength());
		Assert.assertEquals(SmppConstants.CMD_ID_DELIVER_SM_RESP,
				pdu0.getCommandId());
		Assert.assertEquals(0, pdu0.getCommandStatus());
	...
	public void decodeDeliverSmRespWithEmptyMessageId() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("00000011800000050000000000116ac700");
	...
	public void decodeDeliverSmRespWithNoMessageId() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("00000010800000050000000000116ac7");
	...
	public void decodeDataSmResp() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("0000001c800001030000000000116ac7393432353834333135393400");

		DataSmResp pdu0 = (DataSmResp) transcoder.decode(buffer);

		Assert.assertEquals(28, pdu0.getCommandLength());
		Assert.assertEquals(SmppConstants.CMD_ID_DATA_SM_RESP,
				pdu0.getCommandId());
		Assert.assertEquals(0, pdu0.getCommandStatus());
		Assert.assertEquals(1141447, pdu0.getSequenceNumber());
		Assert.assertEquals(true, pdu0.isResponse());
	...
	public void decodeDataSmRespWithEmptyMessageId() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("00000011800001030000000000116ac700");
	...
	public void decodeDataSmRespWithNoMessageId() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("00000010800001030000000000116ac7");
	...
	public void decodeBindTransceiverResp() throws Exception {
		...
		BindTransceiverResp pdu0 = (BindTransceiverResp) transcoder
				.decode(buffer);

		Assert.assertEquals(31, pdu0.getCommandLength());
		Assert.assertEquals(SmppConstants.CMD_ID_BIND_TRANSCEIVER_RESP,
				pdu0.getCommandId());
		Assert.assertEquals(0, pdu0.getCommandStatus());
	...
	@Test
	public void decodeBindTransceiverRespFailedButWithSystemId()
			throws Exception {
		// this specific PDU actually failed with legacy smpp library
		ChannelBuffer buffer = BufferHelper
				.createBuffer("00000015800000090000000e00004db3534d534300");
	...
	public void decodeBindTransceiverRespWithOptionalParams() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("0000001d800000090000000000039943536d7363204757000210000134");
		...
		Assert.assertEquals(true, pdu0
				.hasOptionalParameter(SmppConstants.TAG_SC_INTERFACE_VERSION));
		Assert.assertEquals(SmppConstants.TAG_SC_INTERFACE_VERSION, pdu0
				.getOptionalParameters().get(0).getTag());
		Assert.assertEquals(1, pdu0.getOptionalParameters().get(0).getLength());
		Assert.assertArrayEquals(new byte[] { (byte) 0x34 }, pdu0
				.getOptionalParameters().get(0).getValue());
	...
	public void decodeBindTransmitterRespWithOptionalParams() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("0000001d80000002000000000003995f54574954544552000210000134");

		BindTransmitterResp pdu0 = (BindTransmitterResp) transcoder
				.decode(buffer);

		Assert.assertEquals(29, pdu0.getCommandLength());
		Assert.assertEquals(SmppConstants.CMD_ID_BIND_TRANSMITTER_RESP,
				pdu0.getCommandId());
		Assert.assertEquals(0, pdu0.getCommandStatus());
	...
	public void decodeBindReceiverRespWithOptionalParams() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("0000001d80000001000000000003996274776974746572000210000134");

		BindReceiverResp pdu0 = (BindReceiverResp) transcoder.decode(buffer);

		Assert.assertEquals(29, pdu0.getCommandLength());
		Assert.assertEquals(SmppConstants.CMD_ID_BIND_RECEIVER_RESP,
				pdu0.getCommandId());
		Assert.assertEquals(0, pdu0.getCommandStatus());
		...
		Assert.assertEquals(true, pdu0
				.hasOptionalParameter(SmppConstants.TAG_SC_INTERFACE_VERSION));
		Tlv tlv0 = pdu0
				.getOptionalParameter(SmppConstants.TAG_SC_INTERFACE_VERSION);
		Assert.assertEquals(SmppConstants.TAG_SC_INTERFACE_VERSION,
				tlv0.getTag());
	...
	public void decodeBindTransceiver() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("00000023000000090000000000039951414c4c5f545700414c4c5f5457000034010200");

		BindTransceiver pdu0 = (BindTransceiver) transcoder.decode(buffer);

		Assert.assertEquals(35, pdu0.getCommandLength());
		Assert.assertEquals(SmppConstants.CMD_ID_BIND_TRANSCEIVER,
				pdu0.getCommandId());
		Assert.assertEquals(0, pdu0.getCommandStatus());
		Assert.assertEquals(235857, pdu0.getSequenceNumber());
		Assert.assertEquals(true, pdu0.isRequest());
	...
	public void decodeBindTransmitter() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("0000002500000002000000000003995f747769747465720074776974746572000034000000");

		BindTransmitter pdu0 = (BindTransmitter) transcoder.decode(buffer);

		Assert.assertEquals(37, pdu0.getCommandLength());
		Assert.assertEquals(SmppConstants.CMD_ID_BIND_TRANSMITTER,
				pdu0.getCommandId());
		Assert.assertEquals(0, pdu0.getCommandStatus());
		Assert.assertEquals(235871, pdu0.getSequenceNumber());
		Assert.assertEquals(true, pdu0.isRequest());
	...
	public void decodeBindReceiver() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("00000025000000010000000000039961747769747465720074776974746572000034000000");

		BindReceiver pdu0 = (BindReceiver) transcoder.decode(buffer);

		Assert.assertEquals(37, pdu0.getCommandLength());
		Assert.assertEquals(SmppConstants.CMD_ID_BIND_RECEIVER,
				pdu0.getCommandId());
		Assert.assertEquals(0, pdu0.getCommandStatus());
	...
	public void decodeDeliverSm() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("000000400000000500000000000000030002013837363534333231000409343034303400000000000000000000084024232125262F3A000E0001010006000101");

		DeliverSm pdu0 = (DeliverSm) transcoder.decode(buffer);

		Assert.assertEquals(64, pdu0.getCommandLength());
		Assert.assertEquals(SmppConstants.CMD_ID_DELIVER_SM,
				pdu0.getCommandId());
		Assert.assertEquals(0, pdu0.getCommandStatus());
		...
		Assert.assertArrayEquals(HexUtil.toByteArray("4024232125262f3a"),
				pdu0.getShortMessage());

		Assert.assertEquals(2, pdu0.getOptionalParameters().size());
		Tlv tlv0 = pdu0
				.getOptionalParameter(SmppConstants.TAG_SOURCE_NETWORK_TYPE);
		Assert.assertEquals(0x01, tlv0.getValueAsByte());
		Tlv tlv1 = pdu0
				.getOptionalParameter(SmppConstants.TAG_DEST_NETWORK_TYPE);
	...
	public void decodeDeliverSmAsDeliveryReceipt() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("");
		...
		Assert.assertArrayEquals(
				HexUtil.toByteArray("69643a30303539313133393738207375623a30303120646c7672643a303031207375626d697420646174653a3130303231303137333020646f6e6520646174653a3130303231303137333120737461743a44454c49565244206572723a30303020746578743a4024232125262f3a"),
				pdu0.getShortMessage());
	...
	/**
	 * @Test public void
	 *       decodeDeliverSmNetforsDeliveryReceiptTriggeredErrorInLegacySmppLibrary
	 *       () throws Exception { // interesting -- the optional parameter in
	 *       this TLV is actually incorrect // it has a length of 0x41, but only
	 *       5 bytes were actually included // notified vendor this was a
	 *       mistake, but perhaps we should try to make // this implementation
	 *       work somehow? ChannelBuffer buffer = BufferHelper.createBuffer(
	 *       ""
	 *       );
	 * 
	 ...
	 *       Assert.assertEquals(SmppConstants.CMD_ID_DELIVER_SM,
	 *       pdu0.getCommandId()); Assert.assertEquals(0,
	 *       pdu0.getCommandStatus()); Assert.assertEquals(5,
	 *       pdu0.getSequenceNumber()); Assert.assertEquals(true,
	 *       pdu0.isRequest()); Assert.assertEquals("", pdu0.getServiceType());
	 *       Assert.assertEquals(0x01, pdu0.getSourceAddress().getTon());
	 *       Assert.assertEquals(0x01, pdu0.getSourceAddress().getNpi());
	 ...
	 *       Assert.assertArrayEquals(StringUtil.fromHexString(
	 *       "69643a30303030303033303035207375623a30303120646c7672643a303031207375626d697420646174653a3130303131383134333120646f6e6520646174653a3130303131383134333120737461743a44454c49565244206572723a303030207465"
	 *       ), pdu0.getShortMessage());
	 * 
	 *       Assert.assertEquals(4, pdu0.getOptionalParameters().size()); Tlv
	 *       tlv0 =
	 *       pdu0.getOptionalParameter(SmppConstants.TAG_SOURCE_NETWORK_TYPE);
	 *       Assert.assertEquals(0x01, tlv0.getValueAsByte()); Tlv tlv1 =
	 *       pdu0.getOptionalParameter(SmppConstants.TAG_DEST_NETWORK_TYPE);
	 *       Assert.assertEquals(0x01, tlv1.getValueAsByte()); Tlv tlv2 =
	 *       pdu0.getOptionalParameter(SmppConstants.TAG_RECEIPTED_MSG_ID);
	 *       Assert.assertEquals("38601fa", tlv2.getValueAsString()); Tlv tlv3 =
	 *       pdu0.getOptionalParameter(SmppConstants.TAG_MSG_STATE);
	 *       Assert.assertEquals(SmppConstants.STATE_DELIVERED,
	 *       tlv3.getValueAsByte());
	 * 
	 *       // interesting -- this example has optional parameters it happened
	 *       to skip... Assert.assertEquals(0, buffer.readableBytes()); }
	 */

	@Test
	public void decodeSubmitSm() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("00000039000000040000000000004FE80001013430343034000101343439353133363139323000000000000001000000084024232125262F3A");
	...
	public void decodeUnbind() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("00000010000000060000000000000001");
	...
	public void decodeUnbindResp() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("00000010800000060000000000000001");

		UnbindResp pdu0 = (UnbindResp) transcoder.decode(buffer);

		Assert.assertEquals(16, pdu0.getCommandLength());
		Assert.assertEquals(SmppConstants.CMD_ID_UNBIND_RESP,
				pdu0.getCommandId());
		Assert.assertEquals(0, pdu0.getCommandStatus());
		Assert.assertEquals(1, pdu0.getSequenceNumber());
		Assert.assertEquals(true, pdu0.isResponse());
	...
	public void decodeGenericNak() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("00000010800000000000000100082a77");

		GenericNack pdu0 = (GenericNack) transcoder.decode(buffer);
		logger.debug("{}", pdu0);

		Assert.assertEquals(16, pdu0.getCommandLength());
		Assert.assertEquals(SmppConstants.CMD_ID_GENERIC_NACK,
				pdu0.getCommandId());
		Assert.assertEquals(SmppConstants.STATUS_INVMSGLEN,
				pdu0.getCommandStatus());
	...
	public void decodeDeliverSmWithOptionalMessagePayload() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("000000640000000500000000000547EB0002013434393531333631393200040934303430340000000000000000000000000E000101000600010104240026404D616964656E6D616E363634207761732069742073617070793F2026526F6D616E7469633F");
		...
		Assert.assertArrayEquals(
				HexUtil.toByteArray("404d616964656e6d616e363634207761732069742073617070793f2026526f6d616e7469633f"),
				tlv2.getValue());
	...
	public void decodeDeliverSmWith2BytePayload() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("00000040000000050000000000657E4E0002013434393531333631393200040934303430340000000000000000000000000E0001010006000101042400024F6B");
	...
	public void decodeDeliverSmWith1BytePayload() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("0000003F000000050000000000657E4E0002013434393531333631393200040934303430340000000000000000000000000E0001010006000101042400014F");
	...
	public void decodeDeliverSmWithNoPayload() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("0000003E000000050000000000657E4E0002013434393531333631393200040934303430340000000000000000000000000E000101000600010104240000");
	...
	@Test
	public void decodeDeliverSmWithDeliveryReceiptThatFailedFromEndToEnd()
			throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("");
		...
		Assert.assertEquals(0x01, pdu0.getSourceAddress().getTon());
		Assert.assertEquals(0x01, pdu0.getSourceAddress().getNpi());
		Assert.assertEquals("4495136192057", pdu0.getSourceAddress()
				.getAddress());
		Assert.assertEquals(0x05, pdu0.getDestAddress().getTon());
		Assert.assertEquals(0x01, pdu0.getDestAddress().getNpi());
		...
		Assert.assertArrayEquals(
				HexUtil.toByteArray("69643a3934323531343330393233207375623a30303120646c7672643a303031207375626d697420646174653a3039313130343031323420646f6e6520646174653a3039313130343031323420737461743a41434345505444206572723a31303720746578743a20323646313032"),
				pdu0.getShortMessage());
	...
	public void decodeDeliveryReceipt0() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("");
	...
	public void decodeLargeSequenceNumber() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("000000400000000500000000A2859F22313030310001013434393531333631393230000001343034303430343034303430343034300000000000000000080000");
		...
		Assert.assertEquals(0x00, pdu0.getDestAddress().getTon());
		Assert.assertEquals(0x01, pdu0.getDestAddress().getNpi());
		Assert.assertEquals("4040404040404040", pdu0.getDestAddress()
				.getAddress());
		Assert.assertEquals(0x00, pdu0.getEsmClass());
		Assert.assertEquals(0x00, pdu0.getProtocolId());
		Assert.assertEquals(0x00, pdu0.getPriority());
	...
	public void decodeWAUMalformedPacket() throws Exception {
		 ...
		 * Assert.assertEquals(SmppConstants.CMD_ID_DELIVER_SM,
		 * pdu0.getCommandId()); Assert.assertEquals(0,
		 * pdu0.getCommandStatus()); Assert.assertEquals(-1568301278,
		 * pdu0.getSequenceNumber()); Assert.assertEquals(true,
		 * pdu0.isRequest()); Assert.assertEquals("1001",
		 * pdu0.getServiceType()); Assert.assertEquals(0x01,
		 * pdu0.getSourceAddress().getTon()); Assert.assertEquals(0x01,
		 * pdu0.getSourceAddress().getNpi()); Assert.assertEquals("44951361920",
		 * pdu0.getSourceAddress().getAddress()); Assert.assertEquals(0x00,
		 * pdu0.getDestAddress().getTon()); Assert.assertEquals(0x01,
		 * pdu0.getDestAddress().getNpi());
		 * Assert.assertEquals("4040404040404040",
		 * pdu0.getDestAddress().getAddress()); Assert.assertEquals(0x00,
		 * pdu0.getEsmClass()); Assert.assertEquals(0x00, pdu0.getProtocolId());
		 * Assert.assertEquals(0x00, pdu0.getPriority());
		 * Assert.assertEquals("", pdu0.getScheduleDeliveryTime());
		 * Assert.assertEquals("", pdu0.getValidityPeriod());
		 * Assert.assertEquals(0x00, pdu0.getRegisteredDelivery());
	...
	public void decodeSubmitSmWith255ByteShortMessage() throws Exception {
		...
		ChannelBuffer buffer = BufferHelper
				.createBuffer("00000130000000040000000000004FE80001013430343034000101343439353133363139323000000000000001000000FF"
	...
	@Ignore
	@Test
	public void decodeDeliverSMWithCorrectTotalByteLengthButInvalidShortMessageLength()
			throws Exception {
		// short_message is only 8 bytes, but short_message_length claims it
		// should be 16
		// the problem is that the pdu_length in the header IS set to the
		// correct length
		// this normally causes an IndexOutOfBoundsException on the ByteBuffer
		// read, but
		// this should probably be caught and have a specific exception thrown
		// instead!
		// MX nextel parsing exception in real world
		ChannelBuffer buffer = BufferHelper
				.createBuffer("00000039000000050000000000000001000101393939393139393134353933000000363436340000000000000000080010c1e1e9edf3faf1fc");
	...
	@Test
	public void decodeDeliverSMWithNotPerSpecSequenceNumberButNeedsToBeValid()
			throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("000000390000000500000000806A179B000101393939393139393134353933000000363436340000000000000000080008c1e1e9edf3faf1fc");
	...
	public void decodeDataSM() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("000000300000010300000000000000000001013535353237313030303000000139363935000001000424000454657374");
		...
		// these are NOT actually part of data_sm's, but included for
		// compatability
	...
	public void decodeCancelSm() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("0000002D000000080000000000004FE80031323334350001013430343034000101343439353133363139323000");
	...
	public void decodeQuerySm() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("0000001E000000030000000000004FE83132333435000101343034303400");
	...
	public void decodeCancelSmResp() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("00000010800000080000000000004FE8");

		CancelSmResp pdu0 = (CancelSmResp) transcoder.decode(buffer);

		Assert.assertEquals(16, pdu0.getCommandLength());
		Assert.assertEquals(SmppConstants.CMD_ID_CANCEL_SM_RESP,
				pdu0.getCommandId());
		Assert.assertEquals(0, pdu0.getCommandStatus());
		Assert.assertEquals(20456, pdu0.getSequenceNumber());
		Assert.assertEquals(true, pdu0.isResponse());
	...
	public void decodeQuerySmResp() throws Exception {
		ChannelBuffer buffer = BufferHelper
				.createBuffer("00000019800000030000000000004FE8313233343500000600");

		QuerySmResp pdu0 = (QuerySmResp) transcoder.decode(buffer);

		Assert.assertEquals(25, pdu0.getCommandLength());
		Assert.assertEquals(SmppConstants.CMD_ID_QUERY_SM_RESP,
				pdu0.getCommandId());
		Assert.assertEquals(0, pdu0.getCommandStatus());
		Assert.assertEquals(20456, pdu0.getSequenceNumber());
		Assert.assertEquals("12345", pdu0.getMessageId());
